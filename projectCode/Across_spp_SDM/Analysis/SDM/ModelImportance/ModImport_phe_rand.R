...
sp = c("Cirsium arvense", "Helianthus annuus", "Penstemon eatonii", "Prunus virginiana", "Trillium erectum")
...
system.time({
  ...
  bmdat.h = biomod2::BIOMOD_FormatingData(
    ...
    PA.nb.rep = 10,
    PA.nb.absences = nb.p*3, # same number as presences (Barbet-Massin et al. 2012; Methods Ecol. Evol.) 
...
#for loop preset - species list 
sp = sp = c("Cirsium arvense", "Helianthus annuus", "Penstemon eatonii", "Prunus virginiana", "Trillium erectum")
