...
#This script aggregates monthly (March, April, May) precipitation raster into a 
#yearly spring precipitation raster (1910-1950 & 1985-2025) - for each pixel   
...
tif_files_M2 = list.files(ppt.dir, pattern = "PRISM_ppt_stable_4kmM2_\\d{4}(03|04|05)_tif\\.tif$", full.names = TRUE)
tif_files_M3 = list.files(ppt.dir, pattern = "PRISM_ppt_stable_4kmM3_\\d{4}(03|04|05)_tif\\.tif$", full.names = TRUE)
#combine lists
...
writeRaster(yearly_stack, filename = file.path(L1, #object with output folder pathway 
